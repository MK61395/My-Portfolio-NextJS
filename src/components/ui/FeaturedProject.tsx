  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            'w-full lg:max-w-[60%] absolute inset-0 h-full lg:z-0 lg:object-contain rounded overflow-hidden shadow-2xl group',
            align === 'left' && 'ml-auto'
          )}
        >
          <MediaPreview />
        ...
        <div
          className={cn(
            ...
            'relative lg:absolute lg:top-1/2 lg:-translate-y-1/2 lg:right-0',
            'lg:h-auto left-0 lg:left-auto top-0 right-auto',
